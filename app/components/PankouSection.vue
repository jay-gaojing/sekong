<template>
  <section id="pankou" class="pankou-section" aria-labelledby="pankou-title">
    <header class="pankou-hero">
      <p class="eyebrow">A World in Every Knot — An Ode to the Art of Qipao Fasteners</p>
      <h1 id="pankou-title">一扣一世界：旗袍盘扣美学志</h1>
      <p class="hero-copy">
        盘扣，又称"盘纽"，是旗袍结构中不可或缺的装饰性闭合件，凝结了中国结、刺绣、裁剪等多种非遗技艺。本页面为您系统分类展示盘扣的工艺类型与造型样式，便于查阅、研究与应用。
      </p>
    </header>
